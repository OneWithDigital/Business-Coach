...
const HOW_IT_WORKS = [
  {
    ...
    body: "Idea validation to ongoing compliance, in order — or skip around if you already know where you are.",
  },
  {
    step: "2",
    ...
    <div className="min-h-screen">
      <header className="border-b border-slate-200">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          <span className="text-lg font-bold text-slate-900">Business Formation Coach</span>
        ...
        <div className="space-y-20 py-12 sm:py-16">
          ...
          <section>
            <div className="max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-wide text-emerald-700">Free account · No credit card</p>
              <h1 className="mt-3 text-3xl sm:text-4xl font-bold text-slate-900 leading-tight">
                Go from business idea to registered, banked, and running — without overpaying for what your state
                gives you free.
              </h1>
              <p className="mt-4 text-base text-slate-600 leading-relaxed">
                An 11-stage guided path with real tools built in — not a generic checklist. Finish it, and one
                click turns everything you entered into a professional business plan you can print.
              </p>
              ...
              <p className="mt-3 text-xs text-slate-400">
                Free, takes about a minute. Already have an account?{" "}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="mt-3 text-sm text-slate-600 leading-relaxed">
                  Not a fill-in-the-blank template. Your target customer, pricing rationale, costs, entity choice,
                  and marketing plan — collected naturally as you work through the guide — become the actual input
                  for a professionally written plan, ready to print or save as a PDF.
                </p>
                <Link
                  href="/signup"
                ...
                <div className="mt-3 space-y-3">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-slate-500 leading-relaxed">
                      Riverside Cleaning Co. provides biweekly residential cleaning for working parents in
                      mid-size cities who don't have time for a deep clean...
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-bold text-slate-900">Financial Plan</p>
                    <p className="mt-1 text-xs text-slate-500 leading-relaxed">
                      With a contribution margin of $105 per cleaning job and monthly fixed costs of $330,
                      break-even is roughly 4 jobs per month...
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className="rounded-2xl bg-slate-900 px-6 py-10 sm:px-10 text-center">
            <h2 className="text-xl sm:text-2xl font-bold text-white">Create your free account and get started.</h2>
            <p className="mt-2 text-sm text-slate-300">No credit card, no catch — just an email and a password.</p>
            <div className="mt-6">
              <Link
                href="/signup"
